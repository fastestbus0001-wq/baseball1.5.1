...
import {R, ri, pick, chance, clamp, SEED} from '../core/rng.js?v=1.5.1-r6';
import {LV, PATHS, CPBL_TEAMS, NPB_TEAMS, MLB_TEAMS} from '../data/teams.js?v=1.5.1-r6';
import {AMA_ANNUAL, LEVEL_MIN_ANNUAL, MLB_SERVICE_MINOR_MIN} from '../data/economy.js?v=1.5.1-r6';
import {card, choose, board} from '../ui/dom.js?v=1.5.1-r6';
import {tlNote} from '../ui/timeline.js?v=1.5.1-r6';
import {ovr} from './ability.js?v=1.5.1-r6';
import {injuryMarketStatus} from './injury.js?v=1.5.1-r6';
import {hasActiveFranchise} from './tenure.js?v=1.5.1-r6';
import {seasonSalaryRating, currentSalaryRating} from './season.js?v=1.5.1-r6';
import {capTeam} from './career.js?v=1.5.1-r6';
import {traitCard, removeTrait} from '../flow/events.js?v=1.5.1-r6';
import {advance} from './draft.js?v=1.5.1-r6';
import {finishContractYear} from '../flow/phases.js?v=1.5.1-r6';
